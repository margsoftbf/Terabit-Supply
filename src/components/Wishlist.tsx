		...
		<div>
			<Popover className='ml-4 flow-root text-sm lg:relative lg:ml-8'>
				<Popover.Button
					...
					className='flex items-center p-2 text-gray-400 hover:text-gray-500 border-none outline-none'
				>
					<HeartIcon className='h-6 w-6' aria-hidden='true' />
					<span className='sr-only'>Wishlist Icon</span>
				</Popover.Button>

				{isWishlistOpen && (
					<div className='absolute inset-x-0 top-16 mt-px bg-white pb-6 shadow-lg sm:px-2 lg:left-auto lg:right-0 lg:top-full lg:-mr-1.5 lg:mt-3 lg:w-80 lg:rounded-lg border-2 m-4 rounded-md'>
						<XMarkIcon
